...
export const HTML_TAGS: any = Object.freeze(htmlTags)
...
export const BLOCK_TYPE7 = Object.freeze(
  htmlTags.filter(tag => {
    return (
      !BLOCK_TYPE1.find(t => t === tag) && !BLOCK_TYPE6.find(t => t === tag)
    )
  })
)
...
export const DEFAULT_TURNDOWN_CONFIG = Object.freeze({
  ...
  blankReplacement(content: any, node: any, options: any) {
...
export const FORMAT_MARKER_MAP: any = Object.freeze({
  em: '*',
  inline_code: '`',
  strong: '**',
  del: '~~',
