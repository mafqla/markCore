 ...
 */
export const offsetToWordCursor = (lineCursor: any, left: any, right: any) => {
 ...
 */
export const validateLineCursor = (selection: any)=> {
 ...
 */
export const extractWord = (text: any, offset: any) => {
