...
const footnoteCtrl = (ContentState: any) => {
  ContentState.prototype.updateFootnote = function (block: any, line: any) {
  ...
  ContentState.prototype.createFootnote = function (identifier: any) {
    const { blocks } = this;
