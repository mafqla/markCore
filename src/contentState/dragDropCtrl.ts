...
const dragDropCtrl = (ContentState: any) => {
   ...
   */
  ContentState.prototype.createGhost = function (event: any) {
  ...
  ContentState.prototype.dragoverHandler = function (event: any) {
    ...
    if (event.dataTransfer.types.includes('text/uri-list')) {
      ...
      const hasUriItem = items.some((i: any) => i.type === 'text/uri-list')
      const hasTextItem = items.some((i: any) => i.type === 'text/plain')
      const hasHtmlItem = items.some((i: any) => i.type === 'text/html')
  ...
  ContentState.prototype.dragleaveHandler = function (event: any) {
    return this.hideGhost()
  }

  ContentState.prototype.dropHandler = async function (event: any) {
    event.preventDefault()
