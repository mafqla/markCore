...
const clickCtrl = (ContentState: any) => {
  ContentState.prototype.clickHandler = function (event: any) {
  ...
  ContentState.prototype.updateParentsCheckBoxState = function (checkbox: any) {
  ...
  ContentState.prototype.listItemCheckBoxClick = function (checkbox: any) {
