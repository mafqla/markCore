...
const tabCtrl = (ContentState: any) => {
  ContentState.prototype.findNextCell = function (block: any) {
  ...
  ContentState.prototype.findPreviousCell = function (block: any) {
    if (block.functionType !== 'cellContent') {
  ...
  ContentState.prototype.isUnindentableListItem = function (block: any) {
  ...
  ContentState.prototype.unindentListItem = function (block: any, type: any) {
  ...
  ContentState.prototype.checkCursorAtEndFormat = function (
    text: any,
    offset: any
  ) {
  ...
  ContentState.prototype.tabHandler = function (event: any) {
    // disable tab focus
