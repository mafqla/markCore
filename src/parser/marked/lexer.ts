...
function Lexer(this: any, opts: any) {
  this.tokens = [];
...
Lexer.prototype.lex = function (src: string) {
  ...
  const { tokens } = this;
  const hasNoFootnoteTokens:any = [];
  const footnoteTokens: any = [];
...
Lexer.prototype.token = function (src: any, top: any) {
