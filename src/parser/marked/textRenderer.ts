...
TextRenderer.prototype.text = function (text: any) {
  return text
}
...
TextRenderer.prototype.footnoteIdentifier = function (identifier: any, { footnoteId, footnoteIdentifierId, order }: any) {
...
TextRenderer.prototype.image = function (href: any, title: any, text: string) {
  return '' + text
}
