...
function Renderer(this: any, options = {}) {
  this.options = options || defaultOptions
}

Renderer.prototype.frontmatter = function (text: any) {
  return `<pre class="front-matter">\n${text}</pre>\n`
}

Renderer.prototype.multiplemath = function (text: any) {
  let output = ''
...
Renderer.prototype.inlineMath = function (math: any) {
  let output = ''
  if (this.options.mathRenderer) {
...
Renderer.prototype.emoji = function (text: any, emoji: any) {
...
Renderer.prototype.script = function (content: any, marker: string) {
...
Renderer.prototype.footnote = function (footnote: string) {
  return (
...
Renderer.prototype.footnoteItem = function (
  content: any,
  { footnoteId, footnoteIdentifierId }: any
) {
...
Renderer.prototype.blockquote = function (quote: string) {
  return '<blockquote>\n' + quote + '</blockquote>\n'
}

Renderer.prototype.html = function (html: any) {
  return html
}
...
Renderer.prototype.listitem = function (text: string, checked: any) {
  // normal list
...
Renderer.prototype.paragraph = function (text: string) {
  return '<p>' + text + '</p>\n'
}

Renderer.prototype.table = function (header: string, body: string) {
  if (body) body = '<tbody>' + body + '</tbody>'

  return '<table>\n' + '<thead>\n' + header + '</thead>\n' + body + '</table>\n'
}

Renderer.prototype.tablerow = function (content: string) {
  return '<tr>\n' + content + '</tr>\n'
}

Renderer.prototype.tablecell = function (content: string, flags: { header: any; align: string }) {
...
// span level renderer
Renderer.prototype.strong = function (text: string) {
  return '<strong>' + text + '</strong>'
}

Renderer.prototype.em = function (text: string) {
  return '<em>' + text + '</em>'
}

Renderer.prototype.codespan = function (text: string) {
...
Renderer.prototype.del = function (text: string) {
  return '<del>' + text + '</del>'
}

Renderer.prototype.link = function (href: any, title: string, text: string) {
...
Renderer.prototype.image = function (href: any, title: string, text: string) {
  if (!href) {
    return text
  }
...
Renderer.prototype.text = function (text: any) {
  return text
}
