...
function _defaults(options, defaultOptions2) {
  if (!options || typeof options === "function") {
    return defaultOptions2;
  }
  var merged = {};
  for (var attrname in defaultOptions2) {
    merged[attrname] = defaultOptions2[attrname];
  }
...
function drawPath$2(chart, location, points) {
  var i, len;
  var path = "M{0},{1}";
...
function drawLine$1(chart, from, to, text) {
  var i, len;
...
function checkLineIntersection$1(line1StartX, line1StartY, line1EndX, line1EndY, line2StartX, line2StartY, line2EndX, line2EndY) {
...
var flowchart_functions = {
  drawPath: drawPath$2,
  drawLine: drawLine$1,
  checkLineIntersection: checkLineIntersection$1
};
var drawAPI$2 = flowchart_functions;
var drawLine = drawAPI$2.drawLine;
var checkLineIntersection = drawAPI$2.checkLineIntersection;
function Symbol$8(chart, options, symbol) {
  this.chart = chart;
...
Symbol$8.prototype.getAttr = function(attName) {
  if (!this.chart) {
    return void 0;
  }
...
Symbol$8.prototype.initialize = function() {
  this.group.transform("t" + this.getAttr("line-width") + "," + this.getAttr("line-width"));
  this.width = this.group.getBBox().width;
  this.height = this.group.getBBox().height;
};
Symbol$8.prototype.getCenter = function() {
  return {
    x: this.getX() + this.width / 2,
    y: this.getY() + this.height / 2
  };
};
Symbol$8.prototype.getX = function() {
  return this.group.getBBox().x;
};
Symbol$8.prototype.getY = function() {
  return this.group.getBBox().y;
};
Symbol$8.prototype.shiftX = function(x) {
  this.group.transform("t" + (this.getX() + x) + "," + this.getY());
};
Symbol$8.prototype.setX = function(x) {
  this.group.transform("t" + x + "," + this.getY());
};
Symbol$8.prototype.shiftY = function(y) {
  this.group.transform("t" + this.getX() + "," + (this.getY() + y));
};
Symbol$8.prototype.setY = function(y) {
  this.group.transform("t" + this.getX() + "," + y);
};
Symbol$8.prototype.getTop = function() {
  var y = this.getY();
  var x = this.getX() + this.width / 2;
  return { x, y };
};
Symbol$8.prototype.getBottom = function() {
  var y = this.getY() + this.height;
  var x = this.getX() + this.width / 2;
  return { x, y };
};
Symbol$8.prototype.getLeft = function() {
  var y = this.getY() + this.group.getBBox().height / 2;
  var x = this.getX();
  return { x, y };
};
Symbol$8.prototype.getRight = function() {
  var y = this.getY() + this.group.getBBox().height / 2;
  var x = this.getX() + this.group.getBBox().width;
  return { x, y };
};
Symbol$8.prototype.render = function() {
  if (this.next) {
    var self = this;
...
Symbol$8.prototype.renderLines = function() {
  if (this.next) {
...
Symbol$8.prototype.drawLineTo = function(symbol, text, origin) {
...
var flowchart_symbol = Symbol$8;
var Symbol$7 = flowchart_symbol;
var inherits$6 = flowchart_helpers.inherits;
var drawAPI$1 = flowchart_functions;
var drawPath$1 = drawAPI$1.drawPath;
function Condition$2(chart, options) {
  options = options || {};
  Symbol$7.call(this, chart, options);
...
inherits$6(Condition$2, Symbol$7);
Condition$2.prototype.render = function() {
  var self = this;
...
Condition$2.prototype.renderLines = function() {
  if (this.yes_symbol) {
...
var flowchart_symbol_condition = Condition$2;
var Symbol$6 = flowchart_symbol;
var inherits$5 = flowchart_helpers.inherits;
function Parallel$2(chart, options) {
  var symbol = chart.paper.rect(0, 0, 0, 0);
  options = options || {};
  Symbol$6.call(this, chart, options, symbol);
...
inherits$5(Parallel$2, Symbol$6);
Parallel$2.prototype.render = function() {
...
Parallel$2.prototype.renderLines = function() {
...
var flowchart_symbol_parallel = Parallel$2;
var Raphael = raphael_min.exports;
var defaults = flowchart_helpers.defaults;
var defaultOptions = flowchart_defaults;
var Condition$1 = flowchart_symbol_condition;
var Parallel$1 = flowchart_symbol_parallel;
function FlowChart$2(container, options) {
  options = options || {};
...
FlowChart$2.prototype.handle = function(symbol) {
  if (this.symbols.indexOf(symbol) <= -1) {
    this.symbols.push(symbol);
  }
  var flowChart = this;
  if (symbol instanceof Condition$1) {
  ...
  } else if (symbol instanceof Parallel$1) {
...
FlowChart$2.prototype.startWith = function(symbol) {
  this.start = symbol;
  return this.handle(symbol);
};
FlowChart$2.prototype.render = function() {
...
FlowChart$2.prototype.clean = function() {
  if (this.paper) {
    var paperDom = this.paper.canvas;
    paperDom.parentNode && paperDom.parentNode.removeChild(paperDom);
  }
};
var flowchart_chart = FlowChart$2;
var Symbol$5 = flowchart_symbol;
var inherits$4 = flowchart_helpers.inherits;
function Start$1(chart, options) {
  var symbol = chart.paper.rect(0, 0, 0, 0, 20);
  options = options || {};
  options.text = options.text || "Start";
  Symbol$5.call(this, chart, options, symbol);
}
inherits$4(Start$1, Symbol$5);
var flowchart_symbol_start = Start$1;
var Symbol$4 = flowchart_symbol;
var inherits$3 = flowchart_helpers.inherits;
function End$1(chart, options) {
  var symbol = chart.paper.rect(0, 0, 0, 0, 20);
  options = options || {};
  options.text = options.text || "End";
  Symbol$4.call(this, chart, options, symbol);
}
inherits$3(End$1, Symbol$4);
var flowchart_symbol_end = End$1;
var Symbol$3 = flowchart_symbol;
var inherits$2 = flowchart_helpers.inherits;
function Operation$1(chart, options) {
  var symbol = chart.paper.rect(0, 0, 0, 0);
  options = options || {};
  Symbol$3.call(this, chart, options, symbol);
}
inherits$2(Operation$1, Symbol$3);
var flowchart_symbol_operation = Operation$1;
var Symbol$2 = flowchart_symbol;
var inherits$1 = flowchart_helpers.inherits;
var drawAPI = flowchart_functions;
var drawPath = drawAPI.drawPath;
function InputOutput$1(chart, options) {
  options = options || {};
  Symbol$2.call(this, chart, options);
  this.textMargin = this.getAttr("text-margin");
  this.text.attr({
    x: this.textMargin * 3
  });
...
inherits$1(InputOutput$1, Symbol$2);
InputOutput$1.prototype.getLeft = function() {
  var y = this.getY() + this.group.getBBox().height / 2;
  var x = this.getX() + this.textMargin;
  return { x, y };
};
InputOutput$1.prototype.getRight = function() {
  var y = this.getY() + this.group.getBBox().height / 2;
  var x = this.getX() + this.group.getBBox().width - this.textMargin;
  return { x, y };
};
var flowchart_symbol_inputoutput = InputOutput$1;
var Symbol$1 = flowchart_symbol;
var inherits = flowchart_helpers.inherits;
function Subroutine$1(chart, options) {
  var symbol = chart.paper.rect(0, 0, 0, 0);
  options = options || {};
  Symbol$1.call(this, chart, options, symbol);
  symbol.attr({
...
inherits(Subroutine$1, Symbol$1);
var flowchart_symbol_subroutine = Subroutine$1;
var FlowChart$1 = flowchart_chart;
var Start = flowchart_symbol_start;
var End = flowchart_symbol_end;
var Operation = flowchart_symbol_operation;
var InputOutput = flowchart_symbol_inputoutput;
var Subroutine = flowchart_symbol_subroutine;
var Condition = flowchart_symbol_condition;
var Parallel = flowchart_symbol_parallel;
function parse$2(input) {
  ...
  var chart = {
    ...
    drawSVG: function(container, options) {
      ...
      var diagram = new FlowChart$1(container, options);
...
var flowchart_js = FlowChart;
const index = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: flowchart_js
}, [flowchart_js]);
export {
  index as i
};
